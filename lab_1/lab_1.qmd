...
Освоить базовые операции в языке программирования R с помощью пакета swirl.

## Ход выполнения работы

В рамках работы необходимо выполнить 4 урока из 14 существующих.Для начала загрузим пакет Swirl, выберем его во вкладке Packages и введём в строку команду `swirl()`. Далее выбираем курс R Programming и попадаем на список уроков.
