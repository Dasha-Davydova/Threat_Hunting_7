...
В результате выполнения работы были закреплены практические навыки использования языка программирования R для обработки данных

## Вывод

Изучена структура журнала системы Windows Active Directory, получены дополнительные знания об сновных функциях обработки данных экосистемы tidyverse языка R.
